...
- `docs/_sidebar.md` is generated from the `docs/subpage/` file tree by `node scripts/generate-sidebar.js`.
...
- After adding, renaming, or deleting docs that should appear in navigation, rerun `node scripts/generate-sidebar.js`.

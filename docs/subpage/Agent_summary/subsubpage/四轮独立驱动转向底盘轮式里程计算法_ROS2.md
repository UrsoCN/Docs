...
| 模式 | 是否估计 $v_x, v_y$ | 是否估计 $\omega_z$ | 使用的反馈 | 复用的解算函数 |
|---|---|---|---|---|
| 1 平移 | ✅ 四轮投影平均 | 强制 0 | 四轮速度 + 四轮转角 | `solveTranslation` |
| 2 双阿克曼 | ✅ $v\cos\phi$ | ✅ $2v\sin\phi/L$ | 四轮速度 + 四轮转角 + $L, W$ | `solveDualAckermann` |
| 3 原地旋转 | 强制 0 | ✅ 逐轮最小二乘 + 平均 | 四轮速度 + 四轮转角 + 轮心坐标 | `solveSpinning` |
| 0 停止 / 5 只转向 | 强制 0 | 强制 0 | 不参与 | 直接置零 |
| 7 边转向边平移 | ✅ 同平移 | 强制 0 | 四轮速度 + 四轮转角 | `solveTranslation` |
